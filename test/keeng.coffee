      ...
      describe "Album ID: LB93R8GU",->
            it 'should be called "Nonstop Lan & Điệp" and has 10 songs',(done)->
                  ...
                  getFileByHTTP link, (data)->
                        ...
                        expect(album.coverart).to.equal("http://media3.keeng.vn:8082/medias/images/images_thumb/f_medias_6/album/image/2013/08/13/471b6a68185fb3e2136a7a9a8670595e56aee691_208_208.jpg")
