 ...
 */
Pace.prototype.op = function op(count,extraInfo) {
  if (count) {
    this.current = count;
  }
  else {
 ...
 * Update times.
 */
Pace.prototype.setTotal = function setTotal(total){
  this.total = total;
};
...
Pace.prototype.reset = function finished() {
    // Current item number.
  this.current = 0;
